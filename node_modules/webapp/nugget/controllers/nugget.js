...
NuggetController.prototype.createNuggetSubmit = function(request, response) {
    ...
    var nuggetCRUDService = new NuggetManagement.NuggetCRUDService();
    return nuggetCRUDService.createNugget(content, 'markdown', this.getCurrentUserId(request)).then(function(data) {
...
/**
 * Handler for the createNugget() call
 *
 * @param {object} data - data from the createNugget call
 * @param {Express.Response} response - the response object
 * @return {void}
 */
