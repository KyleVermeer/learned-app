...
profileRouter.get('/profile/:userId', profileController.requireAuthentication, profileController.getUserProfile);

var homeRouter = express.Router();
var homeController = new ControllerModule.HomeController();

homeRouter.get('/', homeController.requireAuthentication, homeController.getHomePage.bind(homeController));

var settingsRouter = express.Router();
var settingsController = new ControllerModule.UserSettingsController();

settingsRouter.get('/', settingsController.requireAuthentication, settingsController.getUserSettingsPage.bind(settingsController));
